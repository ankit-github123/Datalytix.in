...
function App() {
  ...
  return (
    ...
    <Drift
  appId="g2itx3x3khki"
  attributes={{ email: "vivek@datalytix.in", company: "datalytix.in" }}
/>
      ...
      <Switch>
       ...
       <Route path="/modules_demo" component={ModulesDemo} />
        ...
        <Route path="/insight/statistics/media_chart2" component={HindiNews}/>
        <Route path="/insight/statistics/media_chart3" component={EnglishNews}/>

  ...
  return (
    <div className="category_Component">
      <div className="category_head_wrap">
        <div>Media is reinventing itself with new ways to</div>
        <div>capture important story.</div>
        <div>
          Datalytix uses millions of signals, historic and real time trends from
          vast internet to provide solutions for media and news agencies. It
          helps them be faster, focused and efficient to their audience.
        </div>
      </div>
